...
<span style = 'font-size: 80%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` Save your job postings (as pdfs, not just the URL) and any associated technical questions/challenges you may get during the interview process -- this not only helps you ensure that you highlight the skills they want see in a candidate but also review and practice past problems</span>
...
Find a partner and practice responding to these technical (albeit silly) questions. A primary goal is to gain confidence in talking through your thought processes out loud as you attempt to answer these questions. You should feel free to ask explicit, clarifying questions (like you might do in an interview). Pick one out of a hat at random to keep things interesting :)

---
### Practice questions

<span style = 'font-size: 80%;'>**1.** How many tennis balls can you fit inside the NCEAS first floor classroom?</span>  
<span style = 'font-size: 80%;'>**2.** How long would it take for you to walk across the Santa Barbara Channel from Ventura Harbor to Scorpion Anchorage.</span>  
<span style = 'font-size: 80%;'>**3.** Explain, in detail, the process of making a cup of coffee.</span>  
<span style = 'font-size: 80%;'>**4.** How many licks does it take to get to the center of a Tootsie Pop?</span>  
<span style = 'font-size: 80%;'>**5.** You have 8 pennies and a scale. One penny weighs more than the others. Determine which penny weighs more in three or fewer steps. </span>  
<span style = 'font-size: 80%;'>**6.** Given a number 1 to 1000, what is the minimum number of guesses you would need to find that particular number if you are only given the hints "higher" or "lower" after each of your guesses.</span>  
<span style = 'font-size: 80%;'>**7.** How would you describe the taste of a cheeseburger (alternatively, substitute a different food here)?</span>  
<span style = 'font-size: 80%;'>**8.** How many keystrokes does it take to wear the letters off your keyboard?</span>  
<span style = 'font-size: 80%;'>**9.** Why don't whales have tails in the same direction as those of sharks?</span>  
<span style = 'font-size: 80%;'>**10.** ?</span>
